...
import BG from '../../public/assets/blur-background.png'
...
export default function Home() {
  ...
  return (
    <>
      ...
      <div>
        <div className="min-h-screen bg-blur bg-cover bg-no-repeat flex flex-col items-center bg-center BG" style={{ backgroundImage: `url(/public/assets/blur-background.png)` }}>
        <BG></BG>
          {/* Titulos */}
