...
import BackG from '../../public/assets/blur-background.png'
  ...
  return (
    <>
      ...
      <div>
        ...
        <img src={BackG} alt=""  className='className="min-h-screen bg-blur bg-cover bg-no-repeat flex flex-col items-center bg-center BackG"'/>
          {/* Titulos */}
