...
export default function Home() {
  ...
  return (
    <>
      ...
      <main>
        <div className='bg-black bg-cover bg-center bg-background'>
          <Link href="/sobre">Ir para pagina Sobre</Link>
        </div>
      </main>

      <div>
        <div className="min-h-screen bg-blur bg-cover bg-no-repeat flex flex-col items-center bg-center bg-background">
