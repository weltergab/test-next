...
import '../../tailwind.config.js'; // Import your Tailwind config file
...
export default function Home() {
  ...
  return (
    <>
      ...
      <main>
        <div className='bg-black backgroundImage'>
          <Link href="/sobre">Ir para pagina Sobre</Link>
        </div>
      </main>

      <div>
        <div className="min-h-screen bg-blur bg-cover bg-no-repeat flex flex-col items-center backgroundImage">
